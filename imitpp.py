...
class PointProcessGenerater(object):
	...
	def fixed_length_rnn(self, rnn_len=5):
		"""
		"""
		...
		actions, states = tf.scan(
			...
			lambda action_state, _: self._dynamic_rnn_unit(action_state[0], action_state[1]), 
		...
		# actions has shape [seq_len, batch_size, feature_size]
	...
	def _reward(self, t, expert_actions, max_learner_len=10):
		...
		"""
		learner_actions, learner_states = self.fixed_length_rnn(rnn_len=max_learner_len)
